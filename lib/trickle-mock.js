            ...
            const seedData = [
                ...
                },
                {
                    ...
                    objectData: {
                        specialty: "فني تجبير",
                        current_region: "جدة",
                        hospital_name: "مستشفى الملك فهد بجدة",
                        desired_regions: ["الرياض"],
                        phone: "966577777777",
                        notes: "أبحث عن بديل مناسب في مدينة الرياض"
                    }
                },
                {
                    objectId: "req_6",
                    ...
                    objectData: {
                        specialty: "فني أشعة",
                        current_region: "المدينة المنورة",
                        hospital_name: "مستشفى الملك فهد بالمدينة",
                        desired_regions: ["جدة", "مكة المكرمة"],
                        phone: "966588888888",
                        notes: "تخصص أشعة عامة، أرغب بالنقل لجدة أو مكة"
                    }
                }
            ];
